...
class ConstantsClassesTranslator implements ConstantsClassesTranslatorInterface
{
	 ...
	 * @throws ConstantsClassesTranslatorException The input constants class does not exist.
	 * @throws ConstantsClassesTranslatorException The output constants class does not exist.
	 */
